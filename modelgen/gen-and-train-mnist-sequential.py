...
import mnist
from datagen.mnist_utils import download_and_extract_mnist_file, convert
...
def remove_file(file_path, max_retries=5, retry_delay=1):
    retries = 0
...
# Usage
tmp_filename = 'C:\\Users\\abhil\\AppData\\Local\\Temp\\tmpviyhm4e7.csv'
